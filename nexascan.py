...
def banner():
    console.print(Panel.fit(
        "[bold green]NexaScan - Nmap Automater Script[/bold green]\n"
...
def run_scan(flags, target):
    console.print(Panel(f"[green]Running scan on [bold]{target}[/bold]...[/green]", border_style="green"))
    loading("Scanning")
...
[cyan]5.[/cyan] Exit  
        ...
        choice = Prompt.ask("[bold yellow]Select Category[/bold yellow]", choices=["1","2","3","4","5"])
